const promoCodes = [
	...
	},
	{
		...
		description: 'Дом выполнен из дерева, стилизован в духе национальной традиции. Под сводами крыши дома расположена уютная спальня с большой кроватью. Здесь также есть гостиная-студия, совмещающая кухню и зону отдыха. Дом расположен в сосновом лесу, что гарантирует гостям свежий и ароматный воздух. Баня, расположенная внутри дома, оснащена просторной парилкой, современным душем, комнатой отдыха. Так же на территории усадьбы организовано бесплатное питание. Для организации трансфера просьба отправить Ваш контактный номер на адрес электронной почты 280918@day4you.by, после получения контактных данных с вами свяжется наш водитель.',
		src: 'village',
		alt: 'village',
		isOpen: false,
	},
